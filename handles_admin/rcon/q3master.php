<?php
 ...
 class q3master {
     ...
     public function getServers( ) {
         ...
         fwrite( $q3mastersock, $this->logmsgq3headerchars . "getservers IW4 61586 full empty" );
         stream_set_timeout( $q3mastersock, 1 );
         $buffer = "";
         while ( $buff = fread( $q3mastersock, 16384 ) ) {
             $buffers[ ] = $buff;
             //$this->logmsg("Packet received:\n" . $buff . "\n\n");
         } //$buff = fread( $q3mastersock, 16384 )
         fclose( $q3mastersock );
         ...
         foreach ( $buffers as $buffer ) {
             ...
             } //strpos( $buffer, $this->logmsgq3responseheader ) == 0
             else {
